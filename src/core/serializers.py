...
class ProductSerializer(ModelSerializer):
    ...
    saler_location_detail = LocationSerializer(
            source="saler_location", read_only=True
        )
    class Meta:
        model = Product
        fields = [
            'id', 'owner', 'name', 'description', 'price', 'code', 'saler_name', 'saler_location', 'saler_location_detail', 
